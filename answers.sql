...
SELECT melon_type, common_name, price, price * 0.73 AS price_in_euros FROM melons;
...
SELECT orders.id, status, order_total FROM Orders JOIN Customers
ON (customers.id=orders.customer_id) WHERE email = 'pclark74@gmail.com';
